...
\begin{tikzpicture}[spy using outlines={circle, magnification=4, connect spies}]
  \begin{axis}[width=6cm, height=3.6cm,
        ...
        legend style={legend pos=south east,
                      ...
                      legend columns=1,
                      legend entries={$\text{Gl}_{\text{b,P1-P1}}$, $\text{V}_{\text{P1-P1}}$, $\text{Gl}_{\text{b,P1}_{\text{DG}}\text{-P2}}$, $\text{V}_{\text{P1}_{\text{DG}}\text{-P2}}$},
                      font=\tiny},
        grid=both
        ]
    \addplot[color=magenta, solid, line join=round] table[x=Points0, y=Velocity0] {./data/bounded_interp_0-01.csv};
    \addplot[color=black, solid, line join=round] table[x=Points0, y=Velocity0] {./data/void_interp_0-01.csv};
    \addplot[color=blue, dashed, line join=round] table[x=Points0, y=Velocity0] {./data/boundeddg_interp_0-01.csv};
    \addplot[color=green!50!black, densely dashdotted, line join=round] table[x=Points0, y=Velocity0] {./data/voiddg_interp_0-01.csv};
